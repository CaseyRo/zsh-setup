...
run_server() {
    ...
    printf "${CYAN}║${NC}    macOS:   %-51.51s${CYAN}║${NC}\n" "Finder > Cmd+K > http://$local_ip:$port/files"
    printf "${CYAN}║${NC}    Windows: %-50.50s${CYAN}║${NC}\n" "Map Network Drive > http://$local_ip:$port/files"
    printf "${CYAN}║${NC}    Linux:   %-51.51s${CYAN}║${NC}\n" "Files > dav://$local_ip:$port/files"
    echo -e "${CYAN}║${NC}                                                               ${CYAN}║${NC}"
    echo -e "${CYAN}╚═══════════════════════════════════════════════════════════════╝${NC}"
    echo ""
