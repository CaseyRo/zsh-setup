...
# ============================================================================
# install/core.sh — argument parsing, module sourcing, and main() dispatch
# ----------------------------------------------------------------------------
# Sourced by install.sh after its root-check has decided we are running as
# a regular user (or inside Docker). All the orchestration logic lives here
# so install.sh stays thin.
# ============================================================================
...
# Get script directory (core.sh lives in install/, so the repo root is ..)
